...
import { faPencilAlt, faLocationDot, faUser } from '@fortawesome/free-solid-svg-icons';
  ...
  useEffect(() => {
    ...
    const fetchUsername = async () => {
      try {
        ...
        setUsername(response.data.username); // Met à jour le nom avec la réponse de l'API
      } catch (error) {
      ...
      <div className="small-cards-container">
        ...
        <div className="small-card">
          ...
          <div className="button-divider">
            <button type="button" className="btn btn-outline-dark btn-long">Aperçu du profil</button>
